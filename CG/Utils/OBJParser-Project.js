...
OBJDoc.prototype.parse = function (fileString, scale, reverse, mtllibString) {
    ...
    this.mtls.push(mtl);
    onReadMTLFile(mtllibString, mtl);
...
OBJDoc.prototype.parseUsemtl = function (sp) {
    var newStr = sp.str.substring(7).replace('\r','');
    return newStr;
}
