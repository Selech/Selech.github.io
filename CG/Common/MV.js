...
// created by Bjørn Vinther (s152423)
// for matrix-vector multiplication
// u is the matrix and v is the vector
function mult2( u, v )
{
    var result = [];
    ...
    if ( u.matrix) {
        if ( u[0].length != v.length ) {
            throw "mult(): trying to multiply a matrix and vector of different dimensions";
        }
        ...
        return result;
            ...
            throw "mult(): first argument is not a matrix.";
    }
}
